...
export default function Home() {
  ...
  const [points,addPoint] = useCounter();
  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <div className={`${styles.paper} ${styles.item}`} >
        ...
        <div className={`${styles.scissor} ${styles.item}`}>
        ...
        <div className={`${styles.rock} ${styles.item}`}>
      ...
      <button className={styles.rules_button} onClick={handleClick}>RULES</button>
      {
        ...
        <div className={styles.rules}>
          ...
          <div className={styles.mobile_rules}>
            coas
          </div>
        </div>
        :
